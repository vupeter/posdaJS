var data = {
   "tags" : {
      ...
      "(0018,0086)" : {
         ...
         "module" : "MR Image",
         "entity" : "Image",
         "desc" : "The echo number used in generating this image. In the case of segmented k-space, it is the effective Echo Number.",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "name" : "Echo Number(s)",
      ...
      "(0028,0102)" : [
         ...
         },
         {
            ...
            "desc" : "Most significant bit for pixel sample data. Each sample shall have the same high bit. High Bit (0028,0102) shall be one less than Bits Stored (0028,0101).",
            "usage" : "M",
            "module" : "MR Image",
            "req" : "1",
            "name" : "High Bit"
      ...
      "(0018,0082)" : {
         "req" : "2C",
         "name" : "Inversion Time",
         "desc" : "Time in msec after the middle of inverting RF pulse to middle of excitation pulse to detect the amount of longitudinal magnetization. Required if Scanning Sequence (0018,0020) has values of IR.",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "entity" : "Image",
      ...
      "(0018,0087)" : {
         "entity" : "Image",
         "desc" : "Nominal field strength of MR magnet, in Tesla",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "module" : "MR Image",
      ...
      "(0018,1083)" : {
         ...
         "module" : "MR Image",
         "usage" : "M",
         "desc" : "Number of R-R intervals acquired.",
         "entity" : "Image",
         "mod_tables" : [
            "table_C.8-4"
         ]
      ...
      "(0018,0094)" : {
         ...
         "desc" : "Ratio of field of view dimension in phase direction to field of view dimension in frequency direction, expressed as a percent.",
         "entity" : "Image",
         "module" : "MR Image",
         "usage" : "M"
      },
      ...
      "(0018,1090)" : {
         ...
         "module" : "MR Image",
         "entity" : "Image",
         "desc" : "Number of images per cardiac cycle.",
         "mod_tables" : [
            "table_C.8-4"
         ]
      },
      ...
      "(0018,1094)" : {
         ...
         "desc" : "Percent of R-R interval, based on Heart Rate (0018,1088), prescribed as a window for a valid/usable trigger.",
         "module" : "MR Image",
         "usage" : "M"
      },
      "(300a,012c)" : {
      ...
      "(0018,0089)" : {
         ...
         "usage" : "M",
         "entity" : "Image",
         "desc" : "Total number of lines in k-space in the 'y' direction collected during acquisition.",
         "mod_tables" : [
            "table_C.8-4"
         ],
      ...
      "(0018,1060)" : {
         ...
         "usage" : "M",
         "module" : "MR Image",
         "desc" : "Time, in msec, between peak of the R wave and the peak of the echo produced. In the case of segmented k-space, the TE(eff) is the time between the peak of the echo that is used to cover the center of k-space. Required for Scan Options (0018,0022) that include heart gating (e.g., CG, PPG, etc.)",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "entity" : "Image"
      ...
      "(0020,0110)" : {
         ...
         "desc" : "Time delta between Images in a dynamic or functional set of Images.",
         "entity" : "Image",
      ...
      "(0018,0088)" : {
         "desc" : "Spacing between slices, in mm. The spacing is measured from the center-to-center of each slice.",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "entity" : "Image",
      ...
      "(0018,1085)" : {
         "desc" : "Description of type of PVC rejection criteria used.",
         "entity" : "Image",
         "mod_tables" : [
            "table_C.8-4"
         ],
      ...
      "(0018,0085)" : {
         ...
         "module" : "MR Image",
         "entity" : "Image",
         "desc" : "Nucleus that is resonant at the imaging frequency. Examples: 31P, 1H",
         "mod_tables" : [
            "table_C.8-4"
         ]
      },
      ...
      "(0018,0084)" : {
         ...
         "entity" : "Image",
         "desc" : "Precession frequency in MHz of the nucleus being addressed",
      ...
      "(0020,0105)" : {
         ...
         "module" : "MR Image",
         "usage" : "M",
         "desc" : "Total number of temporal positions prescribed.",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "entity" : "Image"
      ...
      "(0018,0091)" : {
         ...
         "usage" : "M",
         "entity" : "Image",
         "desc" : "Number of lines in k-space acquired per excitation per image.",
         "mod_tables" : [
            "table_C.8-4"
         ],
         ...
         "desc" : [
            ...
            },
            {
               "content" : [
                  ...
                  {
                     "attrs" : {
                        "xml:id" : "para_d4913305-7113-40b7-9a44-bf2760912307"
                     },
                     "el" : "para",
                     "content" : [
      ...
      "(0018,0024)" : {
         ...
         "usage" : "M",
         "module" : "MR Image",
         "desc" : "User defined name for the combination of Scanning Sequence (0018,0020) and Sequence Variant (0018,0021).",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "entity" : "Image"
      ...
      "(0018,1314)" : {
         "req" : "3",
         "name" : "Flip Angle",
         "desc" : "Steady state angle in degrees to which the magnetic vector is flipped from the magnetic vector of the primary field.",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "entity" : "Image",
      ...
      "(0018,1100)" : {
         ...
         "entity" : "Image",
         "desc" : "Diameter in mm. of the region from within which data were used in creating the reconstruction of the image. Data may exist outside this region and portions of the patient may exist outside this region.",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "module" : "MR Image",
      ...
      "(0018,1084)" : {
         ...
         "entity" : "Image",
         "desc" : "Number of R-R intervals rejected.",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "usage" : "M",
      ...
      "(0018,0095)" : {
         ...
         "entity" : "Image",
         "desc" : "Reciprocal of the total sampling period, in hertz per pixel.",
         "module" : "MR Image",
         "usage" : "M"
      },
      ...
      "(0018,0083)" : {
         ...
         "entity" : "Image",
         "desc" : "Number of times a given pulse sequence is repeated before any parameter is changed"
      },
      ...
      "(0028,0101)" : [
         ...
         },
         {
            "req" : "1",
            "name" : "Bits Stored",
            "desc" : "Number of bits stored for each pixel sample. Each sample shall have the same number of bits stored.",
            "entity" : "Image",
            "mod_tables" : [
               "table_C.8-4"
            ],
      ...
      "(0018,0080)" : {
         ...
         "desc" : "The period of time in msec between the beginning of a pulse sequence and the beginning of the succeeding (essentially identical) pulse sequence. Required except when Scanning Sequence (0018,0020) is EP and Sequence Variant (0018,0021) is not SK.",
         "entity" : "Image",
         "usage" : "M",
         "module" : "MR Image",
         "req" : "2C",
      ...
      "(0018,0081)" : {
         ...
         "module" : "MR Image",
         "usage" : "M",
         "desc" : "Time in ms between the middle of the excitation pulse and the peak of the echo produced (kx=0). In the case of segmented k-space, the TE(eff) is the time between the middle of the excitation pulse to the peak of the echo that is used to cover the center of k-space (i.e.,-kx=0, ky=0).",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "entity" : "Image"
      ...
      "(0018,1316)" : {
         ...
         "usage" : "M",
         "module" : "MR Image",
         "desc" : "Calculated whole body Specific Absorption Rate in watts/kilogram.",
         "mod_tables" : [
            "table_C.8-4"
         ],
         "entity" : "Image"
      ...
      "(0020,0100)" : {
         ...
         "entity" : "Image",
         "desc" : "Temporal order of a dynamic or functional set of Images.",
         "usage" : "M",
         "module" : "MR Image",
         "req" : "3",
      ...
      "(0018,1318)" : {
         "desc" : "The rate of change of the gradient coil magnetic flux density with time (T/s).",
         "entity" : "Image",
         "mod_tables" : [
            "table_C.8-4"
         ],
      ...
      "(0018,1062)" : {
         ...
         "desc" : "Average R-R interval used for the scans, in msec",
         "usage" : "M",
         "module" : "MR Image",
         "req" : "3",
      ...
      "(0018,0093)" : {
         ...
         "entity" : "Image",
         "desc" : "Fraction of acquisition matrix lines acquired, expressed as a percent.",
         "module" : "MR Image",
         "usage" : "M"
      }
   },
   "errors" : [
      ...
      "Can't handle table_8.8-1 (in table_C.7.6.22-2:table_10-2 after (0040,A168))",
      "Can't handle table_8.8-1 (in table_C.7.6.22-2:table_10-2 after (0040,08EA))",
      "Can't handle table_8.8-1 (in table_C.8-4:table_10-7 after (0008,2218))",
      "Can't handle table_8.8-1 (in table_C.8-4:table_10-7 after (0008,2220))",
      "Can't handle table_8.8-1 (in table_C.8-4:table_10-7:table_10-8 after (0008,2228))",
      "Can't handle table_8.8-1 (in table_C.8-4:table_10-7:table_10-8 after (0008,2230))",
      "Can't handle table_8.8-1 (in table_C.8-4:table_10-25 after (0054,0220))",
      "Can't handle table_8.8-1 (in table_C.8-4:table_10-25 after (0054,0222))",
