var data = {
   "tags" : {
      ...
      "(0008,1200)[<0>](0008,1115)[<1>](0008,114a)[<2>](0008,1155)" : {
         ...
         "usage" : "C - Required if Derivation Image Functional Group () is present."
      },
      "(0062,000e)" : {
                     ...
                     "content" : [
                        "\n                        ",
                        {
                           ...
                           "content" : [
                              ...
                              {
                                 "content" : [
                                    "May be used for tracking a finding or feature that is described by this segment, potentially across multiple objects, over time."
                                 ],
                                 "attrs" : {
                                    "xml:id" : "para_ae1cbaf4-bafe-4c0a-a282-f9c440f3bfe7"
                                 },
                                 "el" : "para"
                              },
                              "\n                        "
                        ...
                        "\n                        ",
                        {
                           "content" : [
                              ...
                              {
                                 "content" : [
                                    "May or may not have the same value as Segment Label (0062,0005)."
                                 ],
                                 "attrs" : {
                                    "xml:id" : "para_bc9377e8-79b7-4985-ab7b-d5675e1cf2e0"
                                 },
                                 "el" : "para"
                              },
                              "\n                        "
                        ...
                        "\n                        ",
                        {
                           "content" : [
                              "\n                          ",
                              {
                                 "el" : "para",
                                 "attrs" : {
                                    "xml:id" : "para_6446e408-6f4d-494d-968e-a243d94feb6a"
                                 },
                                 "content" : [
                                    "Related SR instances may exist, for example, to record measurements related to this segment, but need not exist for this Attribute to be used."
                                 ]
                              },
                              "\n                        "
                           ],
                        ...
                        "\n                        ",
                        {
                           ...
                           "content" : [
                              ...
                              {
                                 "content" : [
                                    "This Attribute will have the same value as the value of the ",
                                    {
                                       "el" : "olink",
                                       "content" : [
                                       ...
                                       "attrs" : {
                                          "targetptr" : "DCM_112039",
                                          "targetdoc" : "PS3.16",
                                          "xrefstyle" : "select: nopage"
                                       }
                                    },
                                    " content item in SR instances that reference this Segment in this Segmentation Instance."
                                 ],
                                 "attrs" : {
                                    "xml:id" : "para_6eae24e2-bfba-4094-beec-e75fd44ac5a1"
                                 },
                                 "el" : "para"
                              },
                              "\n                        "
      ...
      "(0020,0052)" : {
         "usage" : "C - Required if Derivation Image Functional Group () is not present. May be present otherwise.",
         ...
         "desc" : [
            "A default single gray unsigned value in which it is recommended that the maximum pixel value in this segment be rendered on a monochrome display. The units are specified in P-Values from a minimum of 0000H (black) up to a maximum of FFFFH (white).",
            {
               ...
               "content" : [
                  ...
                  {
                     "attrs" : {
                        "xml:id" : "para_1cfe33cf-043c-4a55-b393-0eeef96cda83"
                     },
                     "content" : [
                        ...
                        "\n                        ",
                        {
                           "content" : [
                              "\n                          ",
                              {
                                 "el" : "para",
                                 "attrs" : {
                                    "xml:id" : "para_bfcfd20e-9538-4059-9316-d5c0830be33f"
                                 },
                                 "content" : [
                                    "May be used for tracking a finding or feature that is described by this segment, potentially across multiple objects, over time."
                                 ]
                        ...
                        "\n                        ",
                        {
                           "content" : [
                              "\n                          ",
                              {
                                 ...
                                 "attrs" : {
                                    "xml:id" : "para_8d194842-7201-4c47-a558-0ff46d6a0475"
                                 },
                                 "el" : "para"
                              },
                              "\n                        "
                        ...
                        "\n                        ",
                        {
                           ...
                           "content" : [
                              "\n                          ",
                              {
                                 "el" : "para",
                                 "attrs" : {
                                    "xml:id" : "para_1674b0e1-fc50-47ad-83f5-adb781633aa4"
                                 },
                                 "content" : [
                                    "This Attribute will have the same value as the value of the ",
                                    {
   ...
   "errors" : [
      ...
      "Can't handle processing of table_C.7.6.16-1 in Image:Multi-frame Functional Groups of table_A.51-1",
