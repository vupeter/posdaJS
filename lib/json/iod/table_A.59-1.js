   ...
   "tags" : {
      ...
      "(0028,0101)" : [
         ...
         },
         {
            ...
            "desc" : "Number of bits stored for each pixel sample. Shall be equal to Bits Allocated (0028,0100)."
         }
      ],
         ...
         "desc" : [
            ...
            },
            {
               ...
               "content" : [
                  ...
                  {
                     "attrs" : {
                        "xml:id" : "para_12336262-451d-4697-8c6f-7e145975a615"
                     },
                     "el" : "para",
                     "content" : [
                        "When the value is PATIENT, the Plane Position (Patient) and Plane Orientation (Patient) functional group macros will be present, and may or may not contain attributes with identical values to the corresponding attributes in the Plane Position (Volume) and Plane Orientation (Volume) functional group macros; see ",
                        {
                           "attrs" : {
                              "xrefstyle" : "select: label",
                              "linkend" : "sect_A.59.4.1.2"
                           },
                           "el" : "xref"
                        },
                        "."
            ...
            "Specifies the transformation that is used to create the Alpha input to the Blending LUTs.",
            {
               ...
               "content" : [
                  "\n                    ",
                  {
                     ...
                     "attrs" : {
                        "xml:id" : "para_7a1f8774-ac57-46f1-900c-ed952b7919a2"
                     }
                  },
                  "\n                  "
               ]
      ...
      "(0028,0102)" : [
         ...
         },
         {
            ...
            "entity" : "Image",
            "module" : "Enhanced US Image",
            "desc" : "Most significant bit for pixel sample data. High Bit (0028,0102) shall be one less than Bits Stored (0028,0101)."
         }
      ],
      "(0008,1062)" : {
