var data = 
{
   "tags" : {
         ...
         "desc" : [
            ...
            [
               "See ",
               {
                  ...
                  "attrs" : {
                     "targetdoc" : "PS3.17",
                     "xrefstyle" : "template:Table %n \u201c%t\u201d in PS3.17",
                     "targetptr" : "table_OO.1.1-1"
                  }
               },
               " for standard hanging protocols for dentistry."
            ]
         ],
         "mod_tables" : [
            "table_C.11.16-1"
         ...
         "desc" : [
            "Date on which this structured display was created.",
            {
               ...
               "content" : [
                  ...
                  {
                     "attrs" : {
                        "xml:id" : "para_a8e273ec-7024-4f61-99fe-e2b83358ff0c"
                     },
                     "content" : [
      ...
      "(0072,0002)" : {
         ...
         "desc" : [
            "Identifies the hanging protocol that was used in the creation of this structured display.",
            [
               "See ",
               {
                  "attrs" : {
            ...
            "Exactly four dimensionless floating point values, in the range 0.0 to 1.0, indicating the rectangular coordinate position within the Display Environment of the bounding box in which Unformatted Text Value (0070,0006) is to be displayed.",
            {
               "content" : [
                  "\n                  ",
                  {
                     ...
                     "attrs" : {
                        "xml:id" : "para_5ce777b4-35c4-4de3-9994-5537def2c766"
                     },
                     "el" : "para"
                  },
                  "\n                "
            ...
            },
            {
               "content" : [
                  "\n                  ",
                  {
                     ...
                     "attrs" : {
                        "xml:id" : "para_6af1e5fa-0f13-46e6-b834-11269f007413"
                     }
                  },
                  "\n                "
               ],
            ...
            },
            {
               ...
               "content" : [
                  "\n                  ",
                  {
                     ...
                     "attrs" : {
                        "xml:id" : "para_d79c3ad4-aee4-4a0d-b6d4-285df04f67c5"
                     },
                     "el" : "para"
                  },
                  "\n                "
            ...
            "Time at which this structured display was created.",
            {
               ...
               "content" : [
                  "\n                  ",
                  {
                     "el" : "para",
                     "attrs" : {
                        "xml:id" : "para_a45b1717-7889-4a00-997b-0c7f943803bb"
                     },
                     "content" : [
         ...
         "desc" : [
            ...
            "One or more Items shall be included in this Sequence.",
            {
               "content" : [
                  ...
                  {
                     "attrs" : {
                        "xml:id" : "para_47eced0b-6e2d-4b46-ae4a-fbdd8803b4ee"
                     },
                     "content" : [
            ...
            "Required if the value of Image Box Layout Type (0072,0304) is CINE and if Recommended Display Frame Rate (0008,2144) is not present.",
            {
               "content" : [
                  "\n                  ",
                  {
                     "el" : "para",
                     "attrs" : {
                        "xml:id" : "para_38ffe2d4-c653-4123-8584-ec3aabcbe472"
                     },
                     "content" : [
      ...
      "(0072,0422)[<0>](0008,1140)[<1>](0008,9237)" : {
         "usage" : "M",
         "desc" : [
            "Reference to a Softcopy Presentation State SOP Instance or a Volumetric Presentation State SOP Instance to be applied to the referenced image.",
            ...
            "Exactly four dimensionless floating point values, in the range 0.0 to 1.0, indicating the rectangular coordinate position of the Image Box within the Display Environment.",
            {
               "content" : [
                  "\n                  ",
                  {
                     ...
                     "attrs" : {
                        "xml:id" : "para_2a7c5a77-85b4-44f0-8999-d0efd5e6f4ba"
                     },
                     "el" : "para"
                  },
                  "\n                "
         ...
         "desc" : [
            ...
            "The text shall be interpreted as specified by Specific Character Set (0008,0005) if present in the SOP Instance.",
            {
               ...
               "content" : [
                  ...
                  {
                     "attrs" : {
                        "xml:id" : "para_4d51d02d-23fa-4c1a-8fd6-17d69437aa20"
                     },
                     "content" : [
