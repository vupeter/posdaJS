var data = {
   "tags" : {
      ...
      "(0046,0040)" : {
         "entity" : "Measurements",
         "desc" : "The fraction of light that passes through the measured lens optical media, in percent.",
         "module" : "Lensometry Measurements",
         "mod_tables" : [
            "table_C.8.25.8-2"
         ],
      ...
      "(0008,1111)[<0>](0008,1150)" : [
         ...
         {
            "entity" : "Series",
            "module" : "Lensometry Measurements Series",
            "desc" : "Uniquely identifies the referenced SOP Class.",
            "mod_tables" : [
               "table_C.8.25.1-1",
               "table_10-11"
      ...
      "(0046,0038)" : {
         ...
         "desc" : [
            "The type of segment of a lens containing the \"add\" power, as described above",
            {
               "title" : "Enumerated Values:",
               "list" : [
                  [
      ...
      "(0046,0042)" : {
         ...
         "module" : "Lensometry Measurements",
         "desc" : [
            "In a progressive lens, the width in mm of that portion of the lens where there is gradual or progressive increase in \"add\" power.",
            {
               "content" : [
                  "\n                    ",
                  {
                     "attrs" : {
                        "xml:id" : "para_f0cc2cd0-75eb-4f57-9d2c-0c10788910f9"
                     },
                     "el" : "para",
                     "content" : [
                        "See Attributes, Add Near Sequence (0046,0100) and Add Intermediate Sequence (0046,0101) for description of\"add\"."
                     ]
                  },
                  "\n                  "
               ],
      ...
      "(0046,0100)" : {
         ...
         "desc" : [
            "A sequence that specifies refractive measurements of the lens to correct for inability to focus at near while wearing the distance prescription.",
            "Only a single Item shall be included in this Sequence.",
      ...
      "(0046,0101)" : {
         ...
         "desc" : [
            "A sequence that specifies refractive measurements of the lens to correct for inability to focus at intermediate distance while wearing the distance prescription.",
            "Only a single Item shall be included in this Sequence.",
      ...
      "(0046,0146)" : {
         "desc" : "Refractive power of the lens that is the same in all meridians, measured at distance (optical infinity), in diopters.",
         "module" : "Lensometry Measurements",
         "entity" : "Measurements",
         "mod_tables" : [
            "table_C.8.25.8-2"
