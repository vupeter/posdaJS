var data = {
   "errors" : [
      ...
      "Can't handle processing of table_C.7.6.16-1 in Image:Multi-frame Functional Groups of table_A.53-1",
      ...
      "Can't handle table_8.8-1 (in table_C.8.21.2.1-1:table_10-13:table_10-1 after (0040,1101))",
      "Can't handle table_8.8-1 (in table_C.8.21.2.1-1:table_10-13:table_10-1 after (0008,0082))",
      "Can't handle table_8.8-1 (in table_C.8.21.2.1-1:table_10-13 after (0040,0260))",
      "Can't handle table_8.8-1 (in table_C.8.21.3.2-1:table_C.8.21.3.1.1-1 after (0018,0012))",
   ...
   "tags" : {
      ...
      "(0018,9506)[<0>](0020,9529)[<1>](0008,1115)" : {
         "name" : "Referenced Series Sequence",
         "entity" : "Image",
         "module" : "X-Ray 3D Angiographic Image Contributing Sources",
         "desc" : [
            "Sequence of Items each of which includes the Attributes of one Series.",
            "One or more Items shall be included in this sequence."
         ],
      ...
      "(0018,9507)[<0>](0018,9538)[<1>](0018,9330)" : {
         ...
         "entity" : "Image",
         "module" : "X-Ray 3D Angiographic Acquisition",
         "desc" : [
      ...
      "(0018,9507)[<0>](0018,1110)" : {
         ...
         "desc" : [
            [
               "Distance from source to receptor plane perpendicular to the receptor plane in mm or distance in mm from source to detector center on the chest wall line. See ",
               {
                  "el" : "xref",
                  "attrs" : {
      ...
      "(0018,9507)[<0>](0018,9515)" : {
         ...
         "desc" : [
            [
               "Nominal increment of the secondary positioner angle in degrees. Positive values indicate moving from CAU to CRA through the anterior, or from anterior to posterior. See ",
               {
                  "el" : "xref",
                  "attrs" : {
                     "linkend" : "sect_C.8.7.5.1.2",
      ...
      "(0018,9507)[<0>](0018,9538)[<1>](0018,9465)" : {
         "usage" : "U",
         "req" : "1C",
         "entity" : "Image",
         "module" : "X-Ray 3D Angiographic Acquisition",
         "desc" : [
            "Rotation of the X-Ray detector plane for this projection (deg).",
            [
               "See ",
               {
                  "attrs" : {
                     "linkend" : "sect_C.8.19.6.13.1.2",
                     "xrefstyle" : "select: label"
                  },
                  "el" : "xref"
               },
      ...
      "(0018,9507)[<0>](0018,9538)[<1>](0018,9464)" : {
         "module" : "X-Ray 3D Angiographic Acquisition",
         "desc" : [
            "Position of the X-Ray center beam for this projection in the isocenter reference system in the Z direction (deg).",
            [
               "See ",
               {
                  "el" : "xref",
      ...
      "(0018,9507)[<0>](0018,9538)[<1>](0018,9463)" : {
         "usage" : "U",
         "req" : "1C",
         "module" : "X-Ray 3D Angiographic Acquisition",
         "desc" : [
            "Position of the X-Ray center beam for this projection in the isocenter reference system in the X direction (deg).",
            [
               "See ",
               {
                  "el" : "xref",
      ...
      "(0018,9506)[<0>](0018,1401)" : {
         ...
         "module" : "X-Ray 3D Angiographic Image Contributing Sources",
         "desc" : [
            "Code representing the device-specific processing associated with the frame (e.g., Organ Filtering code)",
      ...
      "(0018,9507)[<0>](0018,1147)" : {
         ...
         "module" : "X-Ray 3D Angiographic Acquisition",
         "desc" : [
            "Shape of the Field of View in the referenced images.",
            {
               "list" : [
                  [
                     "RECTANGLE",
      ...
      "(0018,9506)[<0>](0018,1400)" : {
         "mod_tables" : [
            "table_C.8.21.2.1-1"
         ],
         "desc" : [
            "Indicates any visual processing performed on the frame prior to exchange.",
            [
               "See ",
               {
                  "attrs" : {
      ...
      "(0018,9506)[<0>](0018,1164)" : {
         "module" : "X-Ray 3D Angiographic Image Contributing Sources",
         "desc" : [
            "Physical distance measured at the receptor plane of the detector between the centers of each pixel specified by a numeric pair - row spacing value (delimiter) column spacing value in mm.",
            "Required if present and consistent in the contributing SOP Instances."
         ],
         "entity" : "Image",
         "mod_tables" : [
      ...
      "(0018,9507)[<0>](0018,9514)" : {
         ...
         "desc" : [
            [
               "Nominal increment of the primary positioner angle in degrees. Positive values indicate moving from RAO to LAO position through the anterior, or right to vertical. See ",
               {
                  "el" : "xref",
                  "attrs" : {
                     "xrefstyle" : "select: label",
      ...
      "(0018,9507)[<0>](0018,9430)" : {
         "mod_tables" : [
            "table_C.8.21.3.2-1"
         ],
         "module" : "X-Ray 3D Angiographic Acquisition",
         "desc" : [
            "Position of the Isocenter measured in physical detector elements as a row offset followed by a column offset from the TLHC of a rectangle circumscribing the physical detector area.",
