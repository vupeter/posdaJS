var data = 
{
   "errors" : [
      ...
      "Can't handle table_8.8-1 (in table_C.7.6.22-2:table_10-2 after (0040,A168))",
      "Can't handle table_8.8-1 (in table_C.7.6.22-2:table_10-2 after (0040,08EA))",
      "Can't handle table_8.8-1 (in table_C.8-3 after (0018,9346))",
      "Can't handle table_8.8-1 (in table_C.8-3 after (0018,1272))",
      "Can't handle table_8.8-1 (in table_C.8-3:table_10-7 after (0008,2218))",
      "Can't handle table_8.8-1 (in table_C.8-3:table_10-7 after (0008,2220))",
      "Can't handle table_8.8-1 (in table_C.8-3:table_10-7:table_10-8 after (0008,2228))",
      "Can't handle table_8.8-1 (in table_C.8-3:table_10-7:table_10-8 after (0008,2230))",
      "Can't handle table_8.8-1 (in table_C.8-3:table_10-25 after (0054,0220))",
      "Can't handle table_8.8-1 (in table_C.8-3:table_10-25 after (0054,0222))",
   ...
   "tags" : {
      ...
      "(0018,9360)[<0>](0018,0090)" : {
         "usage" : "M",
         "name" : "Data Collection Diameter",
         "desc" : "The diameter in mm of the region over which data were collected.",
         "entity" : "Image",
         "mod_tables" : [
            "table_C.8-3"
         ],
      ...
      "(0018,0022)" : {
         "desc" : "Parameters of scanning sequence.",
         "usage" : "M",
         "name" : "Scan Options",
         "module" : "CT Image",
         "entity" : "Image",
      ...
      "(0018,1271)" : {
         ...
         "desc" : [
            "The diameter, in mm, of a cylinder of water having the same X-Ray attenuation as the patient for this reconstructed slice (e.g., as described in ",
            {
               "el" : "xref",
               "attrs" : {
                  "linkend" : "biblio_AAPM_TG220"
               }
            },
            ")."
         ],
      ...
      "(0018,9318)" : {
         ...
         "desc" : [
            [
               "The x, y, and z coordinates (in the patient coordinate system) of the reconstruction center target point as used for reconstruction in mm. See ",
               {
                  "el" : "xref",
                  "attrs" : {
                     "linkend" : "sect_C.8.15.3.6.1",
                     "xrefstyle" : "select: label"
                  }
               },
               "."
            ],
            {
               "content" : [
                  "\n                    ",
                  {
                     ...
                     "attrs" : {
                        "xml:id" : "para_06a14d9d-f32a-42e2-a68d-fa1372a8dbd8"
                     },
                     "el" : "para"
                  },
                  "\n                  "
         ...
         "desc" : [
            "Distance in mm from source to detector center.",
            {
               ...
               "content" : [
                  ...
                  {
                     "attrs" : {
                        "xml:id" : "para_a895ef49-8d88-46eb-9ac6-42f442e01ee5"
                     },
                     "content" : [
      ...
      "(0018,9305)" : {
         ...
         "desc" : "The time in seconds of a complete revolution of the source around the gantry orbit.",
         "req" : "3",
         "entity" : "Image",
         "mod_tables" : [
            "table_C.8-3"
      ...
      "(0018,9360)[<0>](0018,1190)" : {
         ...
         "entity" : "Image",
         "req" : "1",
         "desc" : "Used nominal size of the focal spot in mm.",
         "usage" : "M",
         "name" : "Focal Spot(s)"
      },
      ...
      "(0018,1120)" : {
         ...
         "desc" : "Nominal angle of tilt in degrees of the scanning gantry. Not intended for mathematical computations."
      },
               ...
               "content" : [
                  "\n                    ",
                  {
                     ...
                     "content" : [
                        "\n                      ",
                        {
                           ...
                           "attrs" : {
                              "xml:id" : "para_2220e9e5-e336-4004-9599-7052c1b3f15e"
                           }
                        },
                        "\n                    "
                     ]
                  ...
                  "\n                    ",
                  {
                     ...
                     "content" : [
                        ...
                        {
                           "attrs" : {
                              "xml:id" : "para_c91af2c7-5090-4be7-836e-d47a7ef56867"
                           },
                           "content" : [
      ...
      "(0018,9313)" : {
         "desc" : [
            "The x, y, and z coordinates (in the patient coordinate system) in mm of the center of the region in which data were collected. See ",
            {
               "attrs" : {
                  "xrefstyle" : "select: label",
                  "linkend" : "sect_C.8.15.3.6.1"
      ...
      "(0018,9360)[<0>](0018,1160)" : {
         ...
         "entity" : "Image",
         "desc" : "Type of filter(s) inserted into the X-Ray beam.",
         "usage" : "M",
         "name" : "Filter Type"
      },
      "(0018,9310)" : {
         ...
         "module" : "CT Image",
         "req" : "3",
         "desc" : "Motion of the table (in mm) during a complete revolution of the source around the gantry orbit.",
         "usage" : "M",
      ...
      "(0018,9360)[<0>](0018,9332)" : {
         ...
         "module" : "CT Image",
         "usage" : "M",
         "desc" : "The exposure expressed in milliampere seconds, for example calculated from exposure time and X-Ray tube current.",
      ...
      "(0018,9311)" : {
         ...
         "usage" : "M",
         "desc" : "Ratio of the Table Feed per Rotation (0018,9310) to the Total Collimation Width (0018,9307).",
         "module" : "CT Image",
         "mod_tables" : [
            "table_C.8-3"
         ],
      ...
      "(0018,9345)" : {
         "desc" : [
            ...
            "), in mGy according to IEC 60601-2-44, Ed.2.1 (Clause 29.1.103.4), The Volume CTDI",
            {
               "content" : [
                  "vol"
               ],
               ...
               "content" : [
                  "\n                    ",
                  {
                     "content" : [
                        "\n                      ",
                        {
                           ...
                           "attrs" : {
                              "xml:id" : "para_f70a3f70-b620-47a5-ad7a-c0aaada0bf7f"
                           }
                        },
                        "\n                    "
                     ],
                  ...
                  "\n                    ",
                  {
                     "content" : [
                        "\n                      ",
                        {
                           ...
                           "attrs" : {
                              "xml:id" : "para_3a16e33c-6cfd-4036-815b-811f51556259"
                           },
                           "el" : "para"
                        },
                        "\n                    "
                  ...
                  "\n                    ",
                  {
                     ...
                     "content" : [
                        ...
                        {
                           "attrs" : {
                              "xml:id" : "para_cc540920-b1c4-4247-a24c-c2b277f4fc97"
                           },
                           "content" : [
               ...
               "content" : [
                  "\n                    ",
                  {
                     ...
                     "content" : [
                        ...
                        {
                           "attrs" : {
                              "xml:id" : "para_aaa610b9-1fbb-469a-8258-cf6024e4f004"
                           },
                           "content" : [
                              "the specific X-Ray source and kV value"
                           ],
                  ...
                  "\n                    ",
                  {
                     "content" : [
                        "\n                      ",
                        {
                           ...
                           "attrs" : {
                              "xml:id" : "para_1c6cb61a-dc32-433b-86c8-633e98aee601"
                           },
                           "el" : "para"
                        },
                        "\n                    "
      ...
      "(0018,9360)[<0>](0018,9330)" : {
         ...
         "usage" : "M",
         "desc" : "Nominal X-Ray tube current in milliamperes."
      },
      ...
      "(0018,1130)" : {
         "name" : "Table Height",
         "usage" : "M",
         "desc" : "The distance in mm of the top of the patient table to the center of rotation; below the center is positive.",
         "mod_tables" : [
            "table_C.8-3"
         ],
         "entity" : "Image",
      ...
      "(0018,9309)" : {
         "name" : "Table Speed",
         "usage" : "M",
         "desc" : "The distance in mm that the table moves in one second during the gathering of data that resulted in this image.",
         "req" : "3",
         "module" : "CT Image",
         "entity" : "Image",
         "mod_tables" : [
            ...
            "The width of a single row of acquired data (in mm).",
            {
               ...
               "content" : [
                  "\n                    ",
                  {
                     ...
                     "attrs" : {
                        "xml:id" : "para_4d8d6ccf-c318-4fcd-ad33-c19233849e2c"
                     }
                  },
                  "\n                  "
               ]
      ...
      "(0018,1272)" : {
         ...
         "req" : "1C",
         "usage" : "M",
         "name" : "Water Equivalent Diameter Method Code Sequence",
         "desc" : [
      ...
      "(0018,9360)[<0>](0018,7050)" : {
         "name" : "Filter Material",
         "usage" : "M",
         "desc" : "The X-Ray absorbing material used in the filter.",
         "req" : "1",
         "module" : "CT Image",
         "entity" : "Image",
         "mod_tables" : [
      ...
      "(0018,9324)" : {
         ...
         "module" : "CT Image",
         "desc" : "A percent value of dose saving due to the use of Exposure Modulation Type (0018,9323). A negative percent value of dose savings reflects an increase of exposure.",
            ...
            "Distance in mm from source to isocenter (center of field of view).",
            {
               "content" : [
                  "\n                    ",
                  {
                     "el" : "para",
                     "attrs" : {
                        "xml:id" : "para_8515d7bb-1340-4f67-b6e6-d717d37bf020"
                     },
                     "content" : [
                  ...
                  "\n                    ",
                  {
                     "content" : [
                        "\n                      ",
                        {
                           ...
                           "attrs" : {
                              "xml:id" : "para_9f1ab88c-da22-457d-83c1-2ebd03d8181a"
                           }
                        },
                        "\n                    "
                     ],
                  ...
                  "\n                    ",
                  {
                     "content" : [
                        "\n                      ",
                        {
                           ...
                           "attrs" : {
                              "xml:id" : "para_fbdf89d7-8db0-413d-89b2-621531d3c954"
                           },
                           "el" : "para"
                        },
                        "\n                    "
         ...
         "desc" : [
            "The width of the total collimation (in mm) over the area of active x-ray detection.",
            {
               ...
               "content" : [
                  ...
                  {
                     "attrs" : {
                        "xml:id" : "para_8e921b73-47e2-476b-a949-90a0dd3c438c"
                     },
                     "content" : [
