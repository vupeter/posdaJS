var data = 
{
   "tags" : {
      ...
      "(3006,0080)[<0>](3006,00b9)" : {
         "entity" : "Structure Set",
         "req" : "3",
         "desc" : [
            "Sequence containing Code used to identify ROI for a particular purpose.",
            "One or more Items are permitted in this Sequence.",
            [
               "See ",
               {
                  "attrs" : {
                     "linkend" : "sect_C.8.8.8.2",
                     "xrefstyle" : "select: label"
                  },
                  "el" : "xref"
               },
      ...
      "(3006,0080)[<0>](3006,00b0)[<1>](3006,00b4)" : {
         ...
         "module" : "RT ROI Observations",
         "desc" : [
            "User-assigned value for physical property.",
            {
               "el" : "note",
               "content" : [
                  "\n                    ",
                  {
                     "el" : "para",
                     "attrs" : {
                        "xml:id" : "para_5e13c03b-0463-4c50-b6a5-c719bebe45e1"
                     },
                     "content" : [
                        "The value has no meaning when ROI Physical Property (3006,00B2) has the value ELEM_FRACTION. Therefore this attribute may contain any value and receivers may ignore that value."
                     ]
                  },
                  "\n                  "
               ]
      ...
      "(3006,0080)[<0>](3006,00b9)[<1>](0040,a170)" : {
         "desc" : [
            "Describes the purpose for which the identification code is assigned.",
            "Only a single Item shall be included in this Sequence."
         ],
         "usage" : "M",
         "entity" : "Structure Set",
      ...
      "(3006,0080)[<0>](0062,0003)" : {
         ...
         "usage" : "M",
         "desc" : [
            "Sequence defining the general category of this ROI.",
            "Only a single Item is permitted in this Sequence.",
            [
               "See Note ",
               {
                  "attrs" : {
                     "linkend" : "note_C.8.8.8_1"
                  },
                  "el" : "xref"
               },
               "."
   ...
   "errors" : [
      ...
      "Can't handle table_8.8-1 (in table_C.8-44 after (0062,0003))",
      "Can't handle table_8.8-1 (in table_C.8-44 after (3006,0086))",
      "Can't handle table_8.8-1 (in table_C.8-44 after (3006,00B9))",
      "Can't handle table_8.8-1 (in table_C.8-44 after (0040,A170))",
