var data = {
   ...
   "tags" : {
      ...
      "(0018,5000)" : {
         ...
         "desc" : "Manufacturer defined character string description of ultrasound output level(s) used in generating a given image. Data may be expressed in dB, %, W/cm2, etc."
      },
      "(0028,2110)" : [
         {
            "desc" : [
