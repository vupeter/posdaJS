var data = {
   "errors" : [
      ...
      "Can't handle processing of table_C.7.6.16-1 in Image:Multi-frame Functional Groups of table_A.66.3-1",
      ...
      "Can't handle table_8.8-1 (in table_C.8.27.2-1 after (0040,A170))",
      "Can't handle table_8.8-1 (in table_C.8.27.5-1 after (0052,0016))",
   ...
   "tags" : {
      ...
      "(0052,0008)" : {
         "req" : "2",
         "entity" : "Image",
         "module" : "Intravascular OCT Acquisition Parameters",
         "name" : "Axial Resolution",
         "mod_tables" : [
            "table_C.8.27.3-1"
         ],
         "desc" : "The full width at half maximum (FWHM) of the axial plane response function, in \u00b5m (measured in air)",
         "usage" : "M"
      },
      "(0008,1164)" : {
      ...
      "(0028,0102)" : [
         ...
         },
         {
            ...
            "name" : "High Bit",
            "module" : "Intravascular OCT Image",
            "req" : "1",
            "entity" : "Image"
         }
      ],
      ...
      "(0018,3103)" : {
         "desc" : [
            "Frame number at which the motorized portion of the acquisition begins.",
         ...
         "module" : "Intravascular Image Acquisition Parameters",
         "req" : "1C",
         "entity" : "Image"
      },
      "(0010,2293)" : {
      ...
      "(0018,9073)" : {
         ...
         "desc" : [
            "The scan time in seconds used to create all frames of an Intravascular Optical Coherence Tomography image.",
      ...
      "(0052,0007)" : {
         ...
         "desc" : "Center optical wavelength of the OCT light source, in \u00b5m.",
         "mod_tables" : [
            "table_C.8.27.3-1"
         ],
         "usage" : "M",
      ...
      "(0052,0011)" : {
         ...
         "desc" : "The number of IVOCT A-lines acquired per second in Hz.",
         "usage" : "M",
         "req" : "1",
         "entity" : "Image",
         "module" : "Intravascular OCT Acquisition Parameters"
      ...
      "(0052,0004)" : {
         ...
         "usage" : "M",
         "desc" : [
            "Index of refraction of the tissue and flush medias used during the Intravascular OCT acquisition.",
      ...
      "(0008,0060)" : [
         ...
         },
         {
            ...
            "usage" : "M",
            "name" : "Modality",
            "module" : "Intravascular OCT Series",
            "req" : "1",
            "entity" : "Series"
         }
      ],
      ...
      "(0008,114a)[<0>](0040,a170)" : {
         ...
         "desc" : "Code describing the purpose of the reference to the SOP Instances. Only a single Item shall be included in this sequence.",
         "usage" : "M",
      ...
      "(0018,3104)" : {
         ...
         "usage" : "M",
         "desc" : [
            "Frame number at which the motorized portion of the acquisition is complete.",
            "Required if IVUS Acquisition (0018,3100) value is MOTORIZED.",
            [
               "See ",
               {
      ...
      "(0028,1221)" : {
         ...
         "usage" : "C - Required if Pixel Presentation (0008,9205) in the IVOCT Image Module equals COLOR.",
      ...
      "(0028,1040)" : {
         "req" : "1",
         "entity" : "Image",
         "module" : "Intravascular OCT Processing Parameters",
         "name" : "Pixel Intensity Relationship",
         "desc" : [
            "The relationship between the pixel sample values and the IVOCT A-line intensity.",
            [
               "See ",
               {
                  "el" : "xref",
         ...
         "usage" : "C - Required if Presentation Intent Type (0008,0068) is FOR PROCESSING."
      },
      ...
      "(0028,0304)" : {
         ...
         "desc" : [
            [
               "The identifier of a color palette (i.e., an instance of the Color Palette Storage SOP Class \"1.2.840.10008.5.1.4.39.1\") that may be used during rendering. See ",
               {
                  "attrs" : {
                     "targetdoc" : "PS3.4",
                     "targetptr" : "PS3.4",
               ...
               " Color Palette Storage Service Class and ",
               {
                  "el" : "olink",
                  "attrs" : {
                     "targetptr" : "PS3.6",
      ...
      "(0052,0034)" : {
         ...
         "entity" : "Image",
         "desc" : [
            "Orientation in degrees at which the 1",
            {
               "el" : "superscript",
               "content" : [
                  "st"
            ...
            " A-line in the frame should be displayed. Value shall be between 0 and 360, with zero representing vertical."
         ],
         "mod_tables" : [
            "table_C.8.27.4-1"
         ],
      ...
      "(0018,3101)" : {
         ...
         "usage" : "M",
         "desc" : [
            "Intravascular imaging catheter pullback rate. Specified in units of mm/sec.",
            "Required if IVUS Acquisition (0018,3100) value is MOTORIZED.",
            [
               "See ",
               {
      ...
      "(0052,0039)" : {
         "desc" : [
            "The type of interpolation used for the Polar to Cartesian scan-conversion.",
            {
               "title" : "Defined Terms:",
               "list" : [
                  [
      ...
      "(0052,0013)" : {
         ...
         "usage" : "M",
         "desc" : [
            "Rate of rotation of the Intravascular rotating catheter during acquisition, in Hz.",
      ...
      "(0052,0031)" : {
         ...
         "desc" : [
            "Direction of rotation of the Intravascular rotating catheter during acquisition, from the perspective of the motor, proximal to distal.",
            {
               "title" : "Enumerated Values:",
               "list" : [
                  [
      ...
      "(0052,0002)" : {
         ...
         "desc" : "Distance from focal point to center of catheter, in mm (measured in air).",
         "mod_tables" : [
            "table_C.8.27.3-1"
         ],
         "usage" : "M",
      ...
      "(0052,0006)" : {
         ...
         "usage" : "M",
         "desc" : [
            "The type of OCT acquisition domain.",
            {
               "list" : [
                  [
                     "TIME",
      ...
      "(0052,0012)" : {
         "usage" : "M",
         "desc" : [
            "Number of A-lines acquired in an IVOCT frame, including unused (padded) A-lines.",
            {
               "content" : [
                  "\n                    ",
                  {
                     "el" : "para",
                     "content" : [
                        "Will be the same as Rows (0028,0010) for a FOR PROCESSING image."
                     ]
                  },
                  "\n                  "
               ],
      ...
      "(0008,2144)" : {
         "usage" : "M",
         "desc" : "Recommended rate at which the frames of an Intravascular OCT image should be displayed in frames/second.",
         "mod_tables" : [
            "table_C.8.27.2-1"
         ],
      ...
      "(0052,0003)" : {
         "usage" : "M",
         "desc" : "The full width at half maximum (FWHM) of the point spread function (PSF) or line spread function (LSF), in \u00b5m (measured in air). Also known as Transverse Resolution.",
         "mod_tables" : [
            "table_C.8.27.3-1"
         ],
         "name" : "Beam Spot Size",
      ...
      "(0052,0014)" : {
         ...
         "desc" : "Spacing of pixels in the A-line (X-axis), in mm.",
         "usage" : "C - Required if Presentation Intent Type (0008,0068) is FOR PROCESSING."
      },
      "(0010,2210)" : {
         "module" : "General Series",
      ...
      "(0052,0016)" : {
         ...
         "desc" : [
            "Mode of access of the Intravascular Imaging Catheter.",
      ...
      "(0052,0026)" : {
         ...
         "usage" : "C - Required if Presentation Intent Type (0008,0068) is FOR PROCESSING.",
         "desc" : [
            "Indicates whether or not Z offset correction was applied to the OCT image frames.",
            {
               "list" : [
                  [
                     "YES",
      ...
      "(0052,003a)" : {
         ...
         "desc" : [
            "Indicates whether or not Refractive Index correction was applied.",
            {
               "type" : "variablelist",
               "list" : [
                  [
      ...
      "(0018,3100)" : {
         ...
         "desc" : [
            "Type of Intravascular Image Acquisition.",
            {
               "type" : "variablelist",
               "list" : [
                  [
      ...
      "(0028,2112)" : {
         ...
         "desc" : [
            "Describes the approximate lossy compression ratio(s) that have been applied to this image. Required if Lossy Image Compression (0028,2110) has a value of \"01\".",
            [
               "See ",
               {
                  "attrs" : {
            ...
            "May be multi-valued if successive lossy compression steps have been applied.",
            {
               "el" : "note",
               "content" : [
                  "\n                    ",
      ...
      "(0052,0009)" : {
         ...
         "desc" : [
            "Maximum detectable sample-to-reference path displacement, in mm (measured in air). This is the radius of the FOR PRESENTATION image in air.",
            {
               "el" : "note",
               "content" : [
                  "\n                    ",
                  {
                     "el" : "para",
                     "content" : [
                        "Ranging Depth is distinct from Penetration Depth, which is the depth to which one can obtain an OCT signal in tissue."
                     ]
                  },
                  "\n                  "
               ]
