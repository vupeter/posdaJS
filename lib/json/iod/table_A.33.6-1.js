var data = {
   ...
   "tags" : {
      ...
      "(0028,9505)[<0>](0008,1140)[<1>](0008,1150)" : {
         "req" : "1",
         "module" : "XA/XRF Presentation State Presentation",
         "entity" : "Presentation State",
         ...
         "usage" : "C - Required if the referenced image(s) are to be displayed with a prescribed preference"
      },
      "(0028,6100)[<0>](0008,1140)[<1>](0008,1150)" : {
         "usage" : "C - Required if the referenced image(s) are to be subtracted",
         "name" : "Referenced SOP Class UID",
         "desc" : "Uniquely identifies the referenced SOP Class.",
         "mod_tables" : [
            "table_C.11.19-1",
         ...
         "entity" : "Presentation State",
         "module" : "XA/XRF Presentation State Mask",
         "req" : "1"
      },
      ...
      "(0028,9505)[<0>](0008,9458)[<1>](0008,9460)" : {
      ...
      "(0028,6100)[<0>](0028,9501)[<1>](0028,9502)[<2>](0028,9503)" : {
         "mod_tables" : [
            "table_C.11.19-1"
         ],
         "desc" : [
      ...
      "(0018,9472)[<0>](0008,1140)[<1>](0008,1155)" : {
         ...
         "entity" : "Presentation State",
         "module" : "XA/XRF Presentation State Shutter",
         "req" : "1"
      },
      "(2050,0010)" : {
         "mod_tables" : [
         ...
         "usage" : "M",
         "entity" : "Presentation State",
         "module" : "Softcopy Presentation LUT",
         "req" : "1C"
      },
      ...
      "(0028,9505)[<0>](0008,1140)" : {
         ...
         "desc" : [
            [
               "Sequence of Items where each Item provides reference to a selected set of Image SOP Class/SOP Instance pairs that are defined in the ",
               {
                  "el" : "xref",
                  "attrs" : {
      ...
      "(0018,9472)[<0>](0008,1140)[<1>](0062,000b)" : {
         "req" : "1C",
         "module" : "XA/XRF Presentation State Shutter",
         "entity" : "Presentation State",
         "usage" : "C - Required if a Display Shutter is to be applied to referenced image(s) and the  is not present",
      ...
      "(0028,9505)[<0>](0008,1140)[<1>](0008,1155)" : {
         "entity" : "Presentation State",
         "usage" : "C - Required if the referenced image(s) are to be displayed with a prescribed preference",
         "name" : "Referenced SOP Instance UID",
         "desc" : "Uniquely identifies the referenced SOP Instance.",
      ...
      "(0028,9505)[<0>](0008,9458)[<1>](0028,1090)" : {
         "desc" : [
            ...
            },
            {
               "content" : [
                  "\n                  ",
                  {
                     ...
                     "el" : "para",
                     "attrs" : {
                        "xml:id" : "para_f74888c2-c48b-4579-bd33-4b61baadbfbe"
                     }
                  },
                  "\n                "
               ],
      ...
      "(0028,6100)[<0>](0028,9501)[<1>](0028,9502)" : {
         "entity" : "Presentation State",
      ...
      "(0028,9505)[<0>](0008,9458)[<1>](0028,9411)" : {
         "req" : "2",
         "module" : "XA/XRF Presentation State Presentation",
         "entity" : "Presentation State",
      ...
      "(0028,6100)[<0>](0028,9422)[<1>](0028,3006)" : {
         "name" : "LUT Data",
         "usage" : "C - Required if the referenced image(s) are to be subtracted",
         "desc" : "LUT Data in this Sequence",
         "mod_tables" : [
      ...
      "(0028,6100)[<0>](0028,9501)[<1>](0028,9506)" : {
         "module" : "XA/XRF Presentation State Mask",
         "req" : "1",
         "usage" : "C - Required if the referenced image(s) are to be subtracted",
            ...
            "Overlapping frame ranges are not permitted.",
            {
               ...
               "content" : [
                  "\n                  ",
                  {
                     ...
                     "el" : "para",
                     "attrs" : {
                        "xml:id" : "para_e090ce30-9edf-4f10-877b-a39d3aaf8ec1"
                     }
                  },
                  "\n                "
               ]
      ...
      "(0018,9472)[<0>](0008,1140)[<1>](0008,1150)" : {
         "name" : "Referenced SOP Class UID",
         "usage" : "C - Required if a Display Shutter is to be applied to referenced image(s) and the  is not present",
         "mod_tables" : [
            "table_C.11.20-1",
      ...
      "(0028,6100)[<0>](0008,1140)" : {
         ...
         "desc" : [
            ...
            [
               ...
               " references more than one SOP Instance."
            ],
      ...
      "(0028,9505)[<0>](0008,9458)[<1>](0008,2142)" : {
         "req" : "1",
         "module" : "XA/XRF Presentation State Presentation",
         "entity" : "Presentation State",
         "mod_tables" : [
      ...
      "(0018,9472)[<0>](0008,1140)[<1>](0008,1160)" : {
         "req" : "1C",
         "module" : "XA/XRF Presentation State Shutter",
         "entity" : "Presentation State",
         "mod_tables" : [
      ...
      "(0028,6100)[<0>](0008,1140)[<1>](0008,1155)" : {
         "entity" : "Presentation State",
         "name" : "Referenced SOP Instance UID",
         "usage" : "C - Required if the referenced image(s) are to be subtracted",
         "desc" : "Uniquely identifies the referenced SOP Instance.",
      ...
      "(0028,6100)[<0>](0028,9422)[<1>](0028,9474)" : {
         "entity" : "Presentation State",
         "desc" : [
      ...
      "(0028,6100)[<0>](0028,9501)[<1>](0028,9502)[<2>](0028,6114)" : {
         "req" : "1",
         "module" : "XA/XRF Presentation State Mask",
         "entity" : "Presentation State",
         "usage" : "C - Required if the referenced image(s) are to be subtracted",
            ...
            "The region is specified by the polygon defined by the Vertices of the Region (0028,9503) attribute. The pixels on the line of the polygon belong to the region.",
            {
               "content" : [
                  "\n                  ",
                  {
                     ...
                     "el" : "para",
                     "attrs" : {
                        "xml:id" : "para_1043a271-e7b2-454c-9b56-19ece56b016c"
                     }
                  },
                  "\n                "
               ],
      ...
      "(0028,9505)[<0>](0008,9458)[<1>](0008,9459)" : {
         "mod_tables" : [
            "table_C.11.21-1"
         ],
      ...
      "(0028,9505)[<0>](0008,9458)[<1>](0008,2143)" : {
         "req" : "1",
         "module" : "XA/XRF Presentation State Presentation",
         "entity" : "Presentation State",
      ...
      "(0028,6100)[<0>](0028,6110)" : {
         ...
         "usage" : "C - Required if the referenced image(s) are to be subtracted",
         "desc" : "Specifies the frame numbers of the pixel data used to generate this mask. Frames in a Multi-frame Image are specified by sequentially increasing number values beginning with 1. Required if the Mask Operation (0028,6101) is AVG_SUB.",
         "mod_tables" : [
            "table_C.11.19-1"
         ],
         "entity" : "Presentation State",
      ...
      "(0028,9505)[<0>](0008,9458)[<1>](0028,9478)" : {
         "module" : "XA/XRF Presentation State Presentation",
         "req" : "1C",
         ...
         "desc" : [
            ...
            ],
            {
               "content" : [
                  ...
                  {
                     "attrs" : {
                        "xml:id" : "para_97f6fdde-4916-4595-a9c6-23fdab5257e6"
                     },
                     "el" : "para",
                     "content" : [
      ...
      "(0028,6100)[<0>](0028,9422)[<1>](0028,9507)" : {
         "module" : "XA/XRF Presentation State Mask",
         "req" : "1",
         "desc" : [
            ...
            "Discontinuous ranges are represented by multiple pairs of numbers. Frames in a Multi-frame Image are specified by sequentially increasing number values beginning with 1.",
            {
               ...
               "content" : [
                  "\n                  ",
                  {
                     ...
                     "el" : "para",
                     "attrs" : {
                        "xml:id" : "para_28f9d63b-2c6d-40d2-a52f-ced1ffd6f7ae"
                     }
                  },
                  "\n                "
               ]
      ...
      "(0028,6100)[<0>](0028,9422)[<1>](0028,3002)" : {
         "entity" : "Presentation State",
         "desc" : [
            "Specifies the format of the LUT Data in this Sequence.",
            [
